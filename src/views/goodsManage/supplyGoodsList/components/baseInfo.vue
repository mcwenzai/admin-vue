	...
	<div class="product-info-wrap">
		<el-form>
			...
			<el-form-item label="商品品牌:" prop="goodsBrand">
				<el-tag effect="plain" v-if="baseInfo.brandName">{{ baseInfo.brandName }}</el-tag>
			</el-form-item>
			<el-form-item label="货品封面:" prop="goodsCover">
				<el-image
			...
			<el-form-item label="货品视频:" prop="goodsVideo">
				<video-player
					class="video-player"
			...
			<el-form-item label="货品图片:" prop="goodsImg">
				<el-image
			...
			<el-form-item label="货源描述:" prop="goodsIntroduce">
				<el-input
					type="textarea"
					:rows="4"
					:readonly="true"
